...
beans_uikit_enqueue_components( array( 'contrast', 'cover', 'animation', 'modal' ) );
beans_uikit_enqueue_components( array( 'sticky', 'slideshow','slider', 'lightbox', 'grid', 'parallax' ), 'add-ons' );
